package aar226_akc55_ayc62_ahl88.newast.expr.arrayaccess;

import aar226_akc55_ayc62_ahl88.ast.Expr;
import aar226_akc55_ayc62_ahl88.ast.Exprs;
...
public class ArrayAccess extends Expr {
    ...
    public ArrayAccess(Expr e, ArrayList<Expr> index, boolean is_stmt, int l, int c) {
        this.e = e;
        this.indexes = index;

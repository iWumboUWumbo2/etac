...
class CUP$EtiParser$actions {
    ...
    RESULT = new EtiInterface(is);
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("topLevelInter",0, CUP$EtiParser$stack.peek(), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 6: // interfaceStar ::= interfaceStar method_interface 
            {
                ...
                Method_Interface mi = CUP$EtiParser$stack.peek().<Method_Interface> value();
                 is.add(mi); RESULT = is;
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("interfaceStar",28, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-1), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 7: // interfaceStar ::= 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("interfaceStar",28, CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 8: // method_interface ::= IDENTIFIER OPEN_PAREN emptyBracketDecl_star CLOSE_PAREN COLON emptyBracketType_plus 
            {
                ...
                ArrayList<Decl> ds = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-3).<ArrayList<Decl>> value();
     ...
     RESULT = new Method_Interface(i,ds,ts);
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("method_interface",27, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-5), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 9: // method_interface ::= IDENTIFIER OPEN_PAREN emptyBracketDecl_star CLOSE_PAREN 
            {
                ...
                ArrayList<Decl> ds = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-1).<ArrayList<Decl>> value();
                
      RESULT = new Method_Interface(i,ds,new ArrayList<Type>());
      
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("method_interface",27, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-3), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 13: // definition ::= globalDecl 
            {
                ...
                Globdecl gd = CUP$EtiParser$stack.peek().<Globdecl> value();
                RESULT = gd; 
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("definition",4, CUP$EtiParser$stack.peek(), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 14: // method ::= IDENTIFIER OPEN_PAREN emptyBracketDecl_star CLOSE_PAREN COLON emptyBracketType_plus block 
            {
                ...
                ArrayList<Decl> ds = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-4).<ArrayList<Decl>> value();
        ...
        case 15: // method ::= IDENTIFIER OPEN_PAREN emptyBracketDecl_star CLOSE_PAREN block 
            {
                ...
                ArrayList<Decl> ds = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2).<ArrayList<Decl>> value();
                int bleft = CUP$EtiParser$stack.peek().left;
                int bright = CUP$EtiParser$stack.peek().right;
                Block b = CUP$EtiParser$stack.peek().<Block> value();
                 // Block b
        ...
        case 16: // emptyBracketDecl_star ::= emptyBracketDecl_star COMMA emptyBracketDecl 
            {
                ...
                ArrayList<Decl> declstar = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2).<ArrayList<Decl>> value();
                int dleft = CUP$EtiParser$stack.peek().left;
                int dright = CUP$EtiParser$stack.peek().right;
                Decl d = CUP$EtiParser$stack.peek().<Decl> value();
        ...
        case 20: // fullBracketType ::= IDENTIFIER fullBracketPlus 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("fullBracketType",26, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-1), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 21: // fullBracketPlus ::= fullBracketPlus OPEN_BRACKET expr CLOSE_BRACKET 
            {
                ...
                Expr e = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-1).<Expr> value();
                 ts.add(e); RESULT = ts; 
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("fullBracketPlus",25, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-3), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 22: // fullBracketPlus ::= OPEN_BRACKET expr CLOSE_BRACKET 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("fullBracketPlus",25, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 23: // globalDecl ::= emptyBracketDecl 
            {
                ...
                Decl ed = CUP$EtiParser$stack.peek().<Decl> value();
        ...
        case 24: // globalDecl ::= emptyBracketDecl GETS value 
            {
                ...
                Decl ed = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2).<Decl> value();
                int vleft = CUP$EtiParser$stack.peek().left;
                int vright = CUP$EtiParser$stack.peek().right;
                Value v = CUP$EtiParser$stack.peek().<Value> value();
        ...
        case 25: // globalDecl ::= globalDecl SEMICOLON 
            {
                ...
                Globdecl gd = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-1).<Globdecl> value();
                RESULT = gd;
    ...
    RESULT = ds;
        ...
        case 39: // expr ::= OPEN_PAREN expr CLOSE_PAREN 
            {
                ...
                RESULT = e1;
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("expr",14, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 54: // expr ::= NOT expr 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("expr",14, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-1), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 56: // expr ::= INTEGER_LITERAL 
            {
                ...
                Long i = CUP$EtiParser$stack.peek().<Long> value();
                 RESULT = new IntLiteral(i,true); 
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("expr",14, CUP$EtiParser$stack.peek(), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 63: // expr ::= OPEN_BRACE exprList COMMA CLOSE_BRACE 
            {
                ...
                RESULT = new ArrayExpr(x); 
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("expr",14, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-3), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 68: // exprList ::= expr 
            ...
            RESULT = temp;
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("exprList",18, CUP$EtiParser$stack.peek(), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 69: // exprList ::= exprList COMMA expr 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("exprList",18, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 70: // stmt ::= declaration_assign_stmt 
            {
                ...
                RESULT = das; 
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("stmt",19, CUP$EtiParser$stack.peek(), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 72: // stmt ::= WHILE expr stmt 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("stmt",19, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 74: // stmt ::= IF expr stmt ELSE stmt 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("stmt",19, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-4), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 76: // stmt ::= IDENTIFIER OPEN_PAREN exprList CLOSE_PAREN 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("stmt",19, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-3), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 78: // multi_declaration_assign_stmt ::= type_list GETS exprList 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("multi_declaration_assign_stmt",22, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 79: // multi_declaration_assign_stmt ::= type_list 
            {
                Stmt RESULT = null;
                int tlleft = CUP$EtiParser$stack.peek().left;
                int tlright = CUP$EtiParser$stack.peek().right;
                ArrayList<Decl> tl = CUP$EtiParser$stack.peek().<ArrayList<Decl>> value();
                 RESULT = new MultiDeclStmt(tl); 
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("multi_declaration_assign_stmt",22, CUP$EtiParser$stack.peek(), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        RESULT = temp;
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("type_list",24, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        RESULT = temp;
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("type_list",24, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-4), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 88: // type_list ::= IDENTIFIER COLON emptyBracketType COMMA IDENTIFIER COLON emptyBracketType 
            ...
            RESULT = temp;
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("type_list",24, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-6), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 92: // declaration_assign_stmt ::= emptyBracketDecl GETS expr 
            {
                ...
                Decl d = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2).<Decl> value();
                int eleft = CUP$EtiParser$stack.peek().left;
                int eright = CUP$EtiParser$stack.peek().right;
    ...
    RESULT = new DeclStmt(d,e);
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("declaration_assign_stmt",21, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 93: // declaration_assign_stmt ::= emptyBracketDecl 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("declaration_assign_stmt",21, CUP$EtiParser$stack.peek(), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 96: // declaration_assign_stmt ::= fullBracketType GETS expr 
            {
                ...
                int dleft = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2).left;
                int dright = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2).right;
                ArrayAccess d = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2).<ArrayAccess> value();
                int eleft = CUP$EtiParser$stack.peek().left;
                int eright = CUP$EtiParser$stack.peek().right;
                Expr e = CUP$EtiParser$stack.peek().<Expr> value();
        ...
        case 97: // block ::= OPEN_BRACE statement_star CLOSE_BRACE 
            {
                ...
                RESULT = new Block(ss);
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("block",15, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 98: // block ::= OPEN_BRACE statement_star SEMICOLON CLOSE_BRACE 
            {
                ...
                RESULT = new Block(ss);
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("block",15, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-3), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 99: // block ::= OPEN_BRACE statement_star SEMICOLON return CLOSE_BRACE 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("block",15, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-4), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 102: // block ::= OPEN_BRACE statement_star SEMICOLON return SEMICOLON CLOSE_BRACE 
            {
                ...
                Return r = CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2).<Return> value();
                ss.add(r); RESULT = new Block(ss);
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("block",15, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-5), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 103: // return ::= RETURN exprList 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("return",23, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-1), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 104: // return ::= RETURN 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("return",23, CUP$EtiParser$stack.peek(), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 105: // statement_star ::= statement_star stmt 
            {
                ...
                Stmt s = CUP$EtiParser$stack.peek().<Stmt> value();
                 ss.add(s); RESULT = ss;
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("statement_star",20, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-1), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 106: // statement_star ::= statement_star SEMICOLON stmt 
            {
                ...
                Stmt s = CUP$EtiParser$stack.peek().<Stmt> value();
                 ss.add(s); RESULT = ss;
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("statement_star",20, CUP$EtiParser$stack.elementAt(CUP$EtiParser$top-2), CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
        ...
        case 107: // statement_star ::= 
            {
                ...
                CUP$EtiParser$result = parser.getSymbolFactory().newSymbol("statement_star",20, CUP$EtiParser$stack.peek(), RESULT);
            }
            return CUP$EtiParser$result;
